...
export const instructions:CompletionItem[] = [
  {label:"nop", labelDetails:{description:"Null operation"},kind:14,documentation:"machine code is all zeroes"},
  ...
  {label:"break", labelDetails:{detail:" 100",description:"Break execution with code"},kind:14,documentation:"Terminate program execution with specified exception code"},
  {label:"break", labelDetails:{description:"Break execution"},kind:14,documentation:"Terminate program execution with exception"},
  {label:"syscall", labelDetails:{description:"Issue a system call"},kind:14,documentation:"Execute the system call specified by value in $v0"},
  ...
  {label:"eret", labelDetails:{description:"Exception return"},kind:14,documentation:"Set Program Counter to Coprocessor 0 EPC register value, set Coprocessor Status register bit 1 (exception level) to zero"},
]